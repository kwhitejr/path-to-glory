...
export type GetMyArmiesQuery = { __typename?: 'Query', myArmies: Array<{ __typename?: 'Army', id: string, name: string, factionId: string, glory: number, renown: number, createdAt: string, updatedAt: string, player: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null } }> };
