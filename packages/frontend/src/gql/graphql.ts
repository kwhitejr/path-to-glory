...
export type GetMyArmiesQuery = { __typename?: 'Query', myArmies: Array<{ __typename?: 'Army', id: string, name: string, factionId: string, glory: number, renown: number, createdAt: string, updatedAt: string, player: { __typename?: 'User', id: string, name: string, email: string } }> };
...
export type GetArmyQuery = { __typename?: 'Query', army?: { __typename?: 'Army', id: string, campaignId: string, name: string, factionId: string, glory: number, renown: number, createdAt: string, updatedAt: string, player: { __typename?: 'User', id: string, name: string, email: string }, units: Array<{ __typename?: 'Unit', id: string, unitTypeId: string, name: string, size: number, wounds: number, veteranAbilities: Array<string>, injuries: Array<string>, enhancements: Array<string>, createdAt: string, updatedAt: string }> } | null };
...
export type GetMeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, email: string, name: string, googleId: string, createdAt: string } | null };
...
export type CreateArmyMutation = { __typename?: 'Mutation', createArmy: { __typename?: 'Army', id: string, campaignId: string, name: string, factionId: string, glory: number, renown: number, createdAt: string, updatedAt: string, player: { __typename?: 'User', id: string, name: string, email: string } } };
...
export type AddUnitMutation = { __typename?: 'Mutation', addUnit: { __typename?: 'Unit', id: string, armyId: string, unitTypeId: string, name: string, size: number, wounds: number, veteranAbilities: Array<string>, injuries: Array<string>, enhancements: Array<string>, createdAt: string, updatedAt: string } };
...
export type UpdateUnitMutation = { __typename?: 'Mutation', updateUnit: { __typename?: 'Unit', id: string, name: string, size: number, wounds: number, veteranAbilities: Array<string>, injuries: Array<string>, enhancements: Array<string>, updatedAt: string } };
...
export type AddVeteranAbilityMutation = { __typename?: 'Mutation', addVeteranAbility: { __typename?: 'Unit', id: string, veteranAbilities: Array<string>, updatedAt: string } };
